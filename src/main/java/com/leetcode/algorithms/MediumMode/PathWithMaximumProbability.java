...
public class PathWithMaximumProbability {
    ...
    public double maxProbability(int n, int[][] edges, double[] succProb, int start, int end) {
        /**
         * Runtime: 70 ms, faster than 73.90% of Java online submissions for Path with Maximum Probability.
         * Memory Usage: 75.4 MB, less than 73.53% of Java online submissions for Path with Maximum Probability.
         */
        ...
        while (!queue.isEmpty()){
            ...
            for (double[] g : adjList[curNode]) {
                ...
                double p = g[1];
                double val = prob[nxt];
                if(curProb*p > val){  // if you are getting more value for corresponding position in prob array update that and add new pair in that
