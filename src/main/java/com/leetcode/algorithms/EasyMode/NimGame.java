...
public class NimGame {
     ...
     * Memory Usage: 37.8 MB, less than 13.51% of Java online submissions for Nim Game.
     */
     ...
     * Reasoning
     *
     * Let us think of the small cases.
     ...
     * Like the problem description says,
     * if there are exactly four stones in the pile, you will lose.
     * Because no matter how many you take,
     ...
     *
     * It is obvious that the same pattern repeats itself for n=4,8,12,16,…n=4,8,12,16,\dotsn=4,8,12,16,…, basically all multiples of 4.
     */
}
