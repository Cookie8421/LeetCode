...
public class CustomerWhoVisitedButDidNotMakeAnyTransactions {
    ...
    /**
     * Runtime: 2119 ms, faster than 17.64% of MySQL online submissions for Customer Who Visited but Did Not Make Any Transactions.
    ...
    /**
     * Runtime: 1150 ms, faster than 73.63% of MySQL online submissions for Customer Who Visited but Did Not Make Any Transactions.
     * Memory Usage: 0B, less than 100.00% of MySQL online submissions for Customer Who Visited but Did Not Make Any Transactions.
     */
    /*
    SELECT DISTINCT v.customer_id, COUNT(*) OVER(PARTITION BY customer_id) count_no_trans
