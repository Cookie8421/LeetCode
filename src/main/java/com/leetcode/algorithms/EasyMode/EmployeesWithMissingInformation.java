...
public class EmployeesWithMissingInformation {
    ...
    /**
     * Runtime: 480 ms, faster than 81.41% of MySQL online submissions for Employees With Missing Information.
    ...
    from Salaries
    where employee_id not in (select employee_id from Employees)) a
